...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public static class ApiWebSecurityConfigurationAdapter extends WebSecurityConfigurerAdapter {
		protected void configure(HttpSecurity http) throws Exception {
			...
			http.authorizeRequests()
					...
					.permitAll().antMatchers("/cadastro/**", "/perfil/**").fullyAuthenticated().and().formLogin()
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/", "/login.jsf", "/javax.faces.resource/**").permitAll()
				.antMatchers("/cadastro/**", "/perfil/**").fullyAuthenticated().and().formLogin().loginPage("/login.jsf")
